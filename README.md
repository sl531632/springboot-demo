...
```
cd existing_repo
git remote add origin http://192.168.0.103/zhu/springboot-demo.git
git branch -M main
...
- [ ] [Set up project integrations](http://192.168.0.103/zhu/springboot-demo/-/settings/integrations)
